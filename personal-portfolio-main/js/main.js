...
let ProjectArray = [
    {
        'name':"International Institute Of Digital Technologies",
        'desc':"International Institute of Digital Technologies (IIDT) is India's 1st Premier Institute for Digital Technologies, established in 2016 at Tirupati by the Government of Andhra Pradesh.",
        'date':"JANUARY, 2024",
        'tech':"Data analysts,power BI,Data Visulization ",
        'type':"Sales & Marketing",
        'url':"https://theblackbucks.com/internships/",
        'imgUrl':"download.jpeg"
    },
    {
        'name':"Value Laden",
        'desc':"Value Laden is an EdTech company that helps students/freshers to grow their technical knowledge.",
        'date':"may, 2023",
        'tech':"python,data analysts,data visulization",
        'type':"Health & Care",
        'url':"https://learn.valueladen.in/",
        'imgUrl':"images.jpeg"
    },
    {
        'name':"REjolt Technologies Pvt.lmd",
        ...
        'type':"portfolio & about ",
        'url':"https://github.com/Anish32/portfolio.git",
        'imgUrl':"images.png"
    },
    {
        'name':"Audisanakara College Of Engineerning & Technology",
        'desc':"developing android applications:An 'Android application' refers to an effective and simple TCP socket-based software program that can be easily installed and executed on an Android device.",
        'date':"march, 2023",
        'tech':"Android Stdio",
        'type':"developing",
    ...
    if(x.matches){
        ...
        front_view.innerHTML=`
            <div class="container" id="new_home">
                <div>
                    <h2 class="zoom-in-element font-cursive text-white">My Self, <span class="text-yellow">PINDUKURU ANISH REDDY</span></h2>
...
function goToWhatsapp() {
    ...
    var url = "https://wa.me/917330699117?text="
    + "Name: " + name + "%0a"
    + "Email: " + email + "%0a"
    + "Message: " + message;
